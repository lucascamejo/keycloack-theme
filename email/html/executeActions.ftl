...
<html>
    <body style="background: #FFFFFF !important;
        ...
        <div style="margin-top: 35px;">
         ...
         <#--  <#else>  -->
            ${kcSanitize(msg("executeActionsBodyHtml",link, linkExpiration, realmName, requiredActionsText, linkExpirationFormatter(linkExpiration), user.getUsername(), user.getFirstName(), user.getLastName()))?no_esc}
